...
double t,n,i,j,k,a,b,c,m,l,r,p1,p2,r1,r2,q,s;
void dihan()
{
    cin>>n; v_in(x,n); r1=*maxof(x);
    cin>>m; v_in(y,m); p1=*maxof(y);
    cin>>k; v_in(z,k); p2=*minof(z);
    
    cin>>a>>b; r2=sqrt((b*p1)/((a*p2)+(b*p1)))*r1;
    printf("%.12f\n",r2);
}
